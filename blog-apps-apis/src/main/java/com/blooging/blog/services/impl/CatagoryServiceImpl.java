...
public class CatagoryServiceImpl implements CatagoryService {
	...
	public void deleteCatagorey(String catagory) {
		Catagorey deletecatagory = this.catagoreyRepo.findByCatagoryName(catagory);
		
		if(deletecatagory == null) {
			throw new ResourceNotFoundException("Catagory", "name", deletecatagory);
		}
		
		this.catagoreyRepo.delete(deletecatagory);
